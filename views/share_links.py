        ...
        if students_df.empty:
            ...
            with st.form("create_student_link"):
                ...
                if st.form_submit_button("🎯 Create Student Link"):
                    ...
                    student = students_col.find_one({"student_id": student_id, **user_filter})
                    st.success(f"✅ Personal link created for {student.get('name', student_id) if student else student_id}")
                    st.code(link, language="text")
